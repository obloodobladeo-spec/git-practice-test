...
class Window(QMainWindow):
    def __init__(self):
        ...
        layout2 = QGridLayout()
        layout2.addWidget(QPushButton("(0,0)"), num, num)
        layout2.addWidget(QPushButton("(0,1)"), num, num)
        layout2.addWidget(QPushButton("(1,0)"), num, num)
        layout2.addWidget(QPushButton("(1,1)"), num, num)
