...
class Menu(QWidget, form_menu):
    def __init__(self, show_inventory, show_ingred):
        super().__init__()
        self.setupUi(self)

        self.time_label.setGeometry(30, 150, 300, 25)
    ...
    def update_time(self):
            ...
            self.time_label.setText(current.toString("현재 시간 : yyyy-MM-dd hh:mm"))
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 페이지 생성
        self.page1 = Menu(self.show_inventory, self.show_inventory2)
